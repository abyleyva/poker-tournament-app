...
const dictionaries = {
  es: {
    ...
    wizard_level_link_duration: "Editar duración en conjunto",
    wizard_level_link_duration_hint: "Cuando está activo, cambiar la duración de un nivel o descanso actualiza la de todos los demás. Cuando está apagado, cada uno se edita por separado.",
    ...
    settings_logos_title: "Logos",
    settings_app_logo_label: "Logo de la aplicación",
    settings_app_logo_hint: "Se muestra en todos los torneos, del lado izquierdo. Los cambios se guardan al instante y afectan a todos tus torneos.",
    settings_tournament_logo_label: "Logo de este torneo",
    settings_tournament_logo_hint: "Solo se muestra en este torneo, del lado derecho.",
    settings_logo_upload: "Subir imagen",
    settings_logo_change: "Cambiar",
    settings_logo_remove: "Quitar",
    settings_logo_uploading: "Subiendo...",
    settings_logo_error_type: "Selecciona un archivo de imagen.",
    settings_logo_error_size: "La imagen es demasiado grande (máx. 5MB).",
    settings_logo_error_too_big_after_resize: "La imagen sigue siendo muy pesada incluso reducida. Prueba con una versión más simple.",
    settings_logo_error_generic: "No se pudo procesar la imagen.",
    ...
    bubble_banner_title: "¡Fase de burbuja!",
    bubble_banner_subtitle: "El próximo eliminado se queda sin premio",
  ...
  en: {
    ...
    wizard_level_link_duration: "Edit duration together",
    wizard_level_link_duration_hint: "When on, changing one level's or break's duration updates every other one to match. When off, each is edited independently.",
    ...
    settings_logos_title: "Logos",
    settings_app_logo_label: "App logo",
    settings_app_logo_hint: "Shown on every tournament, on the left. Changes save instantly and affect all your tournaments.",
    settings_tournament_logo_label: "This tournament's logo",
    settings_tournament_logo_hint: "Only shown on this tournament, on the right.",
    settings_logo_upload: "Upload image",
    settings_logo_change: "Change",
    settings_logo_remove: "Remove",
    settings_logo_uploading: "Uploading...",
    settings_logo_error_type: "Please select an image file.",
    settings_logo_error_size: "The image is too large (max 5MB).",
    settings_logo_error_too_big_after_resize: "The image is still too large even after resizing. Try a simpler image.",
    settings_logo_error_generic: "Couldn't process the image.",
    ...
    bubble_banner_title: "Bubble phase!",
    bubble_banner_subtitle: "The next player eliminated wins nothing",
